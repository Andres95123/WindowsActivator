...
color 1F
echo -------------------------------
echo - W11 Activator by Andres - 			- Servidor %sv% -
echo -------------------------------
echo.
...
echo.
echo 3. Cambiar Servidor
echo 4. Ver caducidad Windows
echo.
set/p S=Elige=
cls
if %S%==1 (goto :Auto)
...
echo -------------------------------
echo.
echo Se ha detectado Windows %WVersion%%WModule%
echo Instalando clave de producto, espere...
...
echo No se ha detectado la version de su Windows, por favor, activelo manualmente
echo.
goto :Inicio
...
echo.
echo 5. Volver al menu de Windows 10
echo.
set/p S2=Elige=
cls
...
echo -------------------------------
echo - Windows Activator by Andres - 			- Servidor %sv% -
echo -------------------------------
echo.
echo 1. Digiboy
echo 2. MSGUIDES
...
:W8Menu
echo ------------------------------
echo - W8/8.1 Activator by Andres - 			- Servidor %sv% -
echo ------------------------------
echo.
...
:ActivarW10
echo Activando con la clave de producto %x%
echo Por favor, no apague el ordenador en el proximo minuto

slmgr /ipk %x%
slmgr /skms %sv%
slmgr /ato

echo Windows Activado correctamente. Presione cualquier tecla para continuar...
